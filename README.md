...
Charlotte, NC • [logan@kzn.sh](mailto:logan@kzn.sh) • [GitHub](https://github.com/kzndotsh) • [LinkedIn](https://linkedin.com/in/kzndotsh)

Full Stack Developer and Solutions Architect building scalable applications and systems. Core stack: React/Next.js, Shadcn/Tailwind, Prisma/Drizzle, Postgres, Docker, CI/CD, Python, Cloudflare. Founder of [All Things Linux](https://allthingslinux.org), a 501(c)(3) nonprofit (20K+ members). Currently building [Tux](https://github.com/allthingslinux/tux) and leading [discord.gg/linux](https://discord.gg/linux) + too many other projects. Graduate of Bloom Institute of Technology's Full Stack Web Development Program. Check out my Arch Linux [dotfiles](https://github.com/kzndotsh/dotfiles).
